...
<div class="flex">
           ...
           <Link to ='/app/newitems' class="text-xl mt-1 pt-8"> 
    ...
    <img src="https://img.freepik.com/free-photo/broccoli-background_1268-24720.jpg?size=626&ext=jpg&ga=GA1.1.1726861027.1704513461&semt=sph" className="w-full" alt="Tailwind CSS Carousel component" />
  </div> 
  <div className="carousel-item w-full">
...
<div className="flex  item-end pr-12 gap-2">
    <button className=" " onClick={increaseCount}class="text-2xl border-4 border h-10 w-10 text-green-700 ">+</button>
        <p class="text-xl">{count}</p>
        <button onClick={decreaseCount} class="text-2xl  h-10 w-10   border-4 text-center text-green-700">-</button>
        </div>
        </div>
...
<div className=" pt-4 flex justify-between">
  ...
  <MdOutlineNavigateNext />
    ...
    <div className="border-`1 border-solid-black-100 flex pt-8 sticky pt-4 ">
         <AiOutlineShoppingCart   className="border-solid border-2   h-16 w-16 rounded-xl h-14 w-14"/>
